      ...
      <div className={styles.grid}>
        ...
        <div className={styles.rightgrid}>
          ...
          <div className={styles.nameinfo}>
            <p>
              Rita is an exceptional team player with an analytical approach to
              developing useful solutions, enjoys building eye-catchy accessible
              user interfaces. A frontend developer focused majorly on the
              frontend side of the web, with experience in React, Nextjs,
              JavaScript. I enjoy building accessible user interfaces.
            </p>
          </div>
          <div className={styles.experience}>
            ...
            <p>
              - Collaborated with designers, product manager on the approach of
              designing accessible UI mockups.
            </p>
            <p>
